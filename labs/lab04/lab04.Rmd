...
Now, let's find all the (country, year) pairs that had a *negative* average *nominal GDP* growth, using `filter` and an anonymous function, then count and display the occurrences of such per each country, starting with the country with the most:
