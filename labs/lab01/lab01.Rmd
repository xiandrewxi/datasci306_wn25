...
For example, if you want to get the course repository on your personal computer, you may run (depending on your section):

```{bash gitCloneEx, eval=FALSE}
git clone https://github.com/jravi123/stats306-w24
git clone https://github.com/markmfredrickson/stats306_winter_2024.git
```
...
- Two kinds of vectors:
  ...
  + Lists: components can be atomic vectors or any other type
