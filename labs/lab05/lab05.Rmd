...
Now, zooming in on the plot over the range $0 to $2000, where is the unusually short bar?
```{r problem1mod, exercise=TRUE}

```

```{r problem1mod-solution}
# The unusually short bar appears to be at $1500.
diamonds %>%
  ggplot(aes(price)) +
  geom_histogram(binwidth = 100) +
