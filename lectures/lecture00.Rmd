...
You can get the the materials using `git` as described on Canvas, but this will not be directly supported during the course. You will need to download the assignments on Posit cloud.
